...
<body>
<form name="studenteditform" method="post" action="studentedit2.php? txtid=<?php echo $id;?>" id="studenteditform">
<div class="container">
  <div class="row">
  ...
  <label for="inputparentContact">Parent Contact No</label>
  <input class="form-control" type="text" id="inputparentContact" name="parentContact"
